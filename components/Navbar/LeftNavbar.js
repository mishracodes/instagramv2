            ...
            <ul className="space-y-2">
                <li>
                    <a href="#" className="flex items-center p-3 my-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span className="hidden xl:inline-block ml-3">Home</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex items-center p-3 my-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span className="hidden xl:inline-block flex-1 ml-3 whitespace-nowrap">Search</span>
                ...
                {session && <li>
                    <a href="#" className="flex items-center p-3 my-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <img src={session.user.image} alt="" className="flex-shrink-0 w-6 h-6 rounded-full" />
                        <span className="hidden xl:inline-block flex-1 ml-3 whitespace-nowrap">Profile</span>
                    </a>
                </li>}
                {/* /more  */}

    ...
    return (
        <>
            ...
            <ul className="space-y-2">
                ...
                <li>
                    <a href="#" className="flex items-center p-3 my-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <img src="https://avatars.githubusercontent.com/u/31859346?s=40&v=4" alt="" className="flex-shrink-0 w-6 h-6 rounded-full" />
            ...
            <div className=' bottom-0 left-0 right-0  py-20'>
                <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <span className="hidden xl:inline-block flex-1 ml-3 whitespace-nowrap">More</span>
                </a>
            </div>
